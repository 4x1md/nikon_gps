...
## Tested Circuit
![Schematic](../images/pcb-rev-b-tests/tested-circuit.png)
...
![Wavewform](../images/pcb-rev-b-tests/001.png)
...
![Wavewform](../images/pcb-rev-b-tests/002.png)
...
![Wavewform](../images/pcb-rev-b-tests/003.png)
...
![Wavewform](../images/pcb-rev-b-tests/004.png)
...
![Wavewform](../images/pcb-rev-b-tests/005.png)
...
![Wavewform](../images/pcb-rev-b-tests/006.png)
...
![Wavewform](../images/pcb-rev-b-tests/007.png)
...
![Wavewform](../images/pcb-rev-b-tests/008.png)
...
![Wavewform](../images/pcb-rev-b-tests/009.png)
...
![Wavewform](../images/pcb-rev-b-tests/010.png)
...
![Dynamic load schematic](../images/pcb-rev-b-tests/dynamic-load.png)

**Switching between 4.4mA and 52mA (743 Ohm and 62 Ohm)**

![Wavewform](../images/pcb-rev-b-tests/011.png)

![Wavewform](../images/pcb-rev-b-tests/012.png)

![Wavewform](../images/pcb-rev-b-tests/013.png)
...
![Wavewform](../images/pcb-rev-b-tests/014.png)

![Wavewform](../images/pcb-rev-b-tests/015.png)

![Wavewform](../images/pcb-rev-b-tests/016.png)
...
![Wavewform](../images/pcb-rev-b-tests/017.png)
...
![Wavewform](../images/pcb-rev-b-tests/018.png)
...
![Wavewform](../images/pcb-rev-b-tests/019.png)
...
![Wavewform](../images/pcb-rev-b-tests/020.png)

![Wavewform](../images/pcb-rev-b-tests/021.png)
...
![Wavewform](../images/pcb-rev-b-tests/022.png)
...
![Wavewform](../images/pcb-rev-b-tests/023.png)
...
![Wavewform](../images/pcb-rev-b-tests/024.png)
...
![Wavewform](../images/pcb-rev-b-tests/025.png)
...
![Wavewform](../images/pcb-rev-b-tests/026.png)
...
![Wavewform](../images/pcb-rev-b-tests/031.png)
...
![Wavewform](../images/pcb-rev-b-tests/032.png)
...
![Wavewform](../images/pcb-rev-b-tests/033.png)
...
![Wavewform](../images/pcb-rev-b-tests/034.png)

![Wavewform](../images/pcb-rev-b-tests/035.png)
...
![Wavewform](../images/pcb-rev-b-tests/036.png)
...
![Wavewform](../images/pcb-rev-b-tests/037.png)

![Wavewform](../images/pcb-rev-b-tests/038.png)
...
![Wavewform](../images/pcb-rev-b-tests/039.png)
...
![Wavewform](../images/pcb-rev-b-tests/040.png)
...
![Wavewform](../images/pcb-rev-b-tests/041.png)
...
![Wavewform](../images/pcb-rev-b-tests/042.png)
...
![Wavewform](../images/pcb-rev-b-tests/043.png)
...
![Wavewform](../images/pcb-rev-b-tests/044.png)
...
![Wavewform](../images/pcb-rev-b-tests/045.png)
...
![Wavewform](../images/pcb-rev-b-tests/046.png)
...
![Wavewform](../images/pcb-rev-b-tests/047.png)

**Acquisition mode**

![Wavewform](../images/pcb-rev-b-tests/048.png)

**Tracking mode**

![Wavewform](../images/pcb-rev-b-tests/049.png)
...
![Wavewform](../images/pcb-rev-b-tests/050.png)

The ripple is ~13mVpp not including the small spikes.

**Acquisition mode**

![Wavewform](../images/pcb-rev-b-tests/051.png)
...
![Wavewform](../images/pcb-rev-b-tests/052.png)

![Wavewform](../images/pcb-rev-b-tests/053.png)

![Wavewform](../images/pcb-rev-b-tests/054.png)
...
![Wavewform](../images/pcb-rev-b-tests/055.png)
...
![Wavewform](../images/pcb-rev-b-tests/056.png)
...
![Wavewform](../images/pcb-rev-b-tests/057.png)
...
![Wavewform](../images/pcb-rev-b-tests/058.png)
